...
describe('ExpensesController.create', () => {
    ...
    it('should handle expense creation error', async () => {
        ...
        (Expense.create as jest.Mock).mockRejectedValue(new Error('Hubo un error'))
...
describe('ExpensesController.updateById', () => { 
    const expenseMock = {
        ...expenses[0],
        update: jest.fn() // Conque exista el update y sea una funcion es suficiente
    }
...
describe('ExpensesController.deleteById', () => {
    ...
    const expenseMock = {
        ...expenses[0],
        destroy: jest.fn() // Conque exista el update y sea una funcion es suficiente
    }
